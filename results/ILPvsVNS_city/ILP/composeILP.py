...
# assign directory
directory = 'results/ILPvsVNS_city/ILP' 

indicator = False
column_start = 0

workbook = xlsxwriter.Workbook('results/ILPvsVNS_city/ILP/compose.xlsx')
        ...
        if k.endswith('txt'):
            ...
            with open(filename.path, 'r') as f:
                for line in f:
                    ...
                    kdom[k].append([line[0].split('.')[0]]+[int(float(line[1]))]+line[2:])
