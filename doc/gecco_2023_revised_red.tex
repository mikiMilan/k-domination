...
\begin{itemize}
  		...
  		%\item {\color{red} The average times (in seconds) of \textsc{Vns}  range from 254.4 seconds for $k=4$ and city \texttt{Oxford} to 3819.2 seconds for $k=4$ and city \texttt{Boston}.}
