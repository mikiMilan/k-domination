 ...
 \end{table}
  ...
  \begin{table}
 	...
 	\begin{tabular}{lrr|lrr}
 		...
 		Belgrade      & 19,586 & 7,561,185  &Belgrade      & 19,586 & 7,561,185\\ 
 		Berlin        & 29,461 & 9,944,851  &Belgrade      & 19,586 & 7,561,185\\
 		Boston        & 44,797 & 28,164,740  &Belgrade      & 19,586 & 7,561,185\\
 		Dublin        & 37,982 & 21,630,466  &Belgrade      & 19,586 & 7,561,185\\
 		Minsk         & 10,487 & 1,375,618  &Belgrade      & 19,586 & 7,561,185\\
 		Belgrade      & 19,586 & 7,561,185  &Belgrade      & 19,586 & 7,561,185\\ 
 		Berlin        & 29,461 & 9,944,851  &Belgrade      & 19,586 & 7,561,185\\
 		Boston        & 44,797 & 28,164,740  &Belgrade      & 19,586 & 7,561,185\\
 		Dublin        & 37,982 & 21,630,466  &Belgrade      & 19,586 & 7,561,185\\
 		Minsk         & 10,487 & 1,375,618  &Belgrade      & 19,586 & 7,561,185\\ \hline
 	\end{tabular}
 \end{table}
...
Table~\ref{tab:small_instances_chars} show the number of vertices and edges of these instances.  
\begin{comment}
	content...
...
\end{comment}}
 ...
 PG and VNS algorithms are run ten times (using different random seeds) per each problem instance. 
  ...
  As stated in ~\cite{corcoran2021heuristics}, all algorithms were implemented in the Python programming language and executed on a desktop computer with an Intel Core i7-8700 CPU. The criteria for termination of SG, PG and BS is finding the first feasible solution.
   ...
   \emph{Parameters tuning}. As mentioned earlier, VNS for MkDPA involves four control parameters: $d_{min}, d_{max}, p_{move}$ and \emph{penalty}. We decided to use on a simple method of tuning the parameters, that is, a grid search. As recommended by the literature~\cite{mladenovic1997variable}, we fixed the parameter $d_{min}$ with a value 1. The sets of parameters used for tuning are:
...
\end{itemize}
   ...
   \begin{table*}[t]
 	...
 	\begin{tabular}{l|rr|rlr|rr|rlr|rr|rlr}
 		...
 		\hline
 		City & Best & Avg. & Alg. & Best & Avg.  & Best & Avg. & Alg. & Best & Avg.& Best & Avg. & Alg. & Best & Avg.\\ \hline
 		Bath&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6\\
		Bath&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6\\
		Bath&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6\\
		Bath&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6\\
		Bath&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6&\bf{38}&38&BS4&43&44.6\\
